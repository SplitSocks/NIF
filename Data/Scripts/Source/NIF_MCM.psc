...
; TODO
; STUCK ON MIN OPTION MORPH ID NOT UPDATING PROPERLY OR LOADING PROPERLY SOMETHING FUCKY
...
Event OnConfigInit()
    ...
    Pages[3] = "Morph Range"
    Pages[4] = "MorphsPerMod"
    Pages[5] = "Morph Exchange"
