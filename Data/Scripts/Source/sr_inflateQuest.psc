...
Function QueueUpdate(Actor kActor, String morphID, string modName, float value, int replaceOrUpdate)
...
Function SetBellyMorphValue(Actor akActor, float value, string MorphName)
	If value != 0.0
		QueueUpdate(akActor, MorphName, FHU_KEY, value/10, 0)
	Else
